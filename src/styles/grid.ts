...
const gridStyles = {
  ...
  sectionContainer:
    "group relative h-full overflow-hidden border border-[var(--ui-border-soft)]/70 bg-[var(--ui-surface-base)] outline-none focus-visible:ring-2 focus-visible:ring-[var(--ui-focus-ring)]",
